...
import com.gameon.mycash_carteiradigital_EN.helper.AdapterListagemDespesas;
import com.gameon.mycash_carteiradigital_EN.helper.DatePickerFragment;
import com.gameon.mycash_carteiradigital_EN.helper.OutputDAO;
import com.gameon.mycash_carteiradigital_EN.helper.RecyclerItemClickListener;
                                ...
                                alertDialog.setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if (outputDAO.delete(outputSelected)){
                                            ...
                                            Toast.makeText(getApplicationContext(), "Error on delete", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
